...
To display the welcome screen without the tutorial prompt, use the -NoTutorial switch.
...
Would you like to run a short interactive tutorial? (Y/N):
```
...
[Start-Tutorial](Start-Tutorial.md)
